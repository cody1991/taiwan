...
今天是 **2026-08-13**。台湾 **8 天**：周五九份、周六故宫、台南 3 晚。订 12/16 那晚落地能睡。12/24 人已经在南山。
...
1. **核对证件**：中国护照剩余效期 > 6 个月。荷兰居留够长，多次硬门槛过了。
2. **盯入台证窗口**：移民署只开放「未来三个月」。台湾 9/17 0 点 = 荷兰 **9/16 18:00** 开始刷，不要等到 9/17 早上。审核大约 4 周。详见 [docs/entry-permit.md](docs/entry-permit.md)。
3. **10 月买去程**：12/16 AMS–TPE，选可改期。证有进度就订可退的 CZ3088。
