...
export const milestones = [
  ...
  { date: "2026-11-15", label: "锁台南酒店和高铁" },
...
export const taiwanDays: TaiwanDay[] = [
  ...
  },
  {
    ...
    title: "九份或北投",
    stay: "台北",
    body: "周五去九份，比周六人少。看早上窗外。晴去九份，雨去北投或淡水。不要临时改阳明山。",
    beats: [
      "晴：尽量上午从忠孝复兴坐 1062，刷悠游卡，大约 1 小时到九份老街。",
      "九份走主街、看海、吃芋圆或鱼丸。不要加金瓜石、十分，来不及。15:30–16:00 在老街口等回程 1062。",
      "雨：淡水信义线到北投，换新北投。公共浴是裸汤，有纹身先问；要泳衣选汤屋。不想泡汤就坐到淡水老街。不要排阳明山。",
      "回台北吃一顿热的。明天故宫，周一才休馆。",
    ],
    tips: ["周五九份比周六松", "16:00 前离开九份", "不加金瓜石"],
    mapsQuery: "九份老街",
  },
  {
    date: "2026-12-19",
    ...
    title: "故宫 + 夜市",
    stay: "台北",
    body: "故宫周六开馆。晚上只跑一条夜市。明天早班去台南，晚上收登机箱。",
    beats: [
      "故宫散客现场买外籍票，约 NT$350。09:00–17:00，16:30 停售。不要在淘宝买团票，对不上护照。",
      "捷运淡水线到士林，出站转红 30 或计程车到故宫正馆。别走去剑潭爬山。",
      "正馆看半天就够。中午馆内或士林吃卤肉饭。",
      "晚上二选一：还在士林就去剑潭旁士林夜市；要回城就下午大稻埕、龙山寺，晚上华西。不要两条都跑。",
    ],
    tips: ["故宫别排周一", "晚上只去一个夜市"],
    mapsQuery: "国立故宫博物院",
  },
  {
    date: "2026-12-20",
    ...
    title: "高铁去台南",
    stay: "台南 3 晚 · 国华街圈",
    body: "早班南下。下午安平，晚饭国华街。高雄不顺路，不要加。",
    beats: [
  ...
  },
  {
    ...
    title: "台南再一天",
    stay: "台南",
    body: "多出来的一天给吃的。花园夜市周二不开。晚上收登机箱，明天早班回台北。",
    beats: [
      "早上可以再喝一碗牛肉汤。没走到的巷子、水仙宫市场、咖啡。",
      "别临时加高雄。安平没看完可以补，看完就坐着。",
      "晚上国华街或保安路。把箱子收好，明天只带登机箱上高铁。",
    ],
    tips: ["砍高雄", "周二没有花园夜市"],
    mapsQuery: "台南 国华街",
  },
  {
    ...
    title: "高铁回台北",
    stay: "台北 1 晚",
    body: "早班北上。下午买伴手礼、看 101。明天飞深圳，晚上早睡。",
    beats: [
      "早班高铁回台北。预留 40 分钟进站。大箱子如果寄在第一家酒店，今天取回。",
      "下午永康街、东门市场买凤梨酥、牛轧糖。来好队不长就买，太长换别家。城里买够，别留到桃园。",
      "想看 101：捷运市政府站，外立面免费。观景台现场买，队长就看外面。同一站诚品、康是美。晚上可补饶河。",
      "检查护照、入台证、CZ3088、充电宝。明天 9:30 前离开市区。",
    ],
...
export const mapStops: MapStop[] = [
  ...
  { id: "taipei", name: "台北", note: "12/16–19 住", lat: 25.0478, lng: 121.517, x: 132, y: 48 },
  { id: "jiufen", name: "九份", note: "12/18 一日", lat: 25.1095, lng: 121.8443, x: 162, y: 40 },
  { id: "tainan", name: "台南", note: "12/20–22 住", lat: 22.9971, lng: 120.2026, x: 88, y: 188 },
  { id: "taipei-back", name: "台北", note: "12/23 住", lat: 25.0478, lng: 121.517, x: 132, y: 48 },
...
export const foodGroups: FoodGroup[] = [
  {
    id: "taipei-night",
    title: "台北夜市",
    when: "12/17 宁夏 · 12/19 士林或华西 · 12/23 可补饶河",
    items: [
      {
        name: "蚵仔煎",
        where: "饶河或宁夏",
        note: "冬天也有。蛋、蚵仔、粉浆，淋粉红酱。选轮转快的摊。第一晚宁夏，朋友也说这条比饶河、士林像本地人。",
        mapsQuery: "饶河夜市 蚵仔煎",
      ...
      },
      {
        name: "珍珠奶茶",
        where: "随处",
        note: "冬天改热的。少糖少冰，连喝两杯会腻。碰到一沐日可以点黑糖柠檬粉粿，热的。",
        mapsQuery: "台北 珍珠奶茶",
      },
      {
        name: "盐酥鸡",
  ...
  },
  {
    id: "tainan",
    title: "台南国华街",
    when: "12/20 晚饭 · 12/21 早上牛肉汤 · 12/22 再一轮",
    items: [
      {
        name: "牛肉汤",
        where: "国华街一带",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: "牛轧糖",
        where: "礼盒店、机场",
        note: "不怕压。永康「来好」的牛轧糖饼干有人专门排队，顺路可以买；队太长就换别家。城里买够了就别在桃园补。",
        mapsQuery: "永康街 来好",
      },
      {
        name: "茶叶、蛋黄酥",
...
export const foodSkip = [
  "芒果冰：12 月不是季节",
  "鼎泰丰：没必要为它排队",
  "按分钟排的两日台北：朋友自己走了两天半，这趟不要抄",
  "太阳饼：别为了它去台中",
  "士林夜市很大，挑摊，不要当任务走完",
];

export const visitReserve = [
  { name: "故宫北院", need: "不用约", note: "散客现场买外籍票约 NT$350。12/19 周六开，周一休。不要淘宝团票。" },
  { name: "龙山寺、大稻埕、九份老街", need: "不用约", note: "走路进去。九份 12/18，只要赶上 1062 回程。" },
  { name: "松山文创园", need: "不用约", note: "12/23 若不去 101，国父纪念馆站顺路逛。别排在赶飞机那天。" },
  { name: "中正纪念堂、国父纪念堂", need: "不用约", note: "12/23 先伴手礼。有空再看换岗。" },
  { name: "花园夜市", need: "不用约", note: "周四六日晚上。12/20 周日有。12/22 周二不开。" },
  { name: "北投", need: "不用约", note: "12/18 下雨才去。公共浴或汤屋现场排队即可。" },
  { name: "安平古堡、赤崁楼、孔庙、林百货", need: "不用约", note: "古蹟现场买几十块门票或免费。林百货周一可能休。" },
  { name: "高铁", need: "要订", note: "护照号订对号座。11 月订 12/20、12/23 早班。" },
];
...
export const lifeStay = [
  ...
  },
  {
    title: "位置比星级重要",
    detail:
      "看捷运出口步行 5 分钟内，以及 24 小时柜台。订 12/16–19 连续 4 晚，跟酒店说 17 日清晨到，不要当 no-show。商务旅馆通常比设计酒店合适。很多有投币洗衣。",
  },
  {
    title: "台北住哪",
    detail:
      "12/16–19 和 12/23 尽量同一家。优先中山或台北车站，机场捷运少换线。朋友推小巨蛋、南京东路新饭店，那一带去九份、高铁都要再换，这趟不跟。西门吵。去台南 3 晚把大箱子带上。12/24 赶中午飞机，最后一晚别订士林、北投。",
  },
  {
    title: "台南住哪",
    detail:
      "12/20–22 住中西区，国华街、海安路、赤崁步行圈。不要住高铁台南站，也不要住永康区（那是另一个行政区，不是台北永康街）。高铁站下车打车进城。",
  },
  {
    title: "房间不用纠结",
    detail:
...
export const lifeTransit = [
  {
    title: "悠游卡",
    detail:
      "桃园机场捷运站或 7-11、全家买。1062 去九份、YouBike、部分公交还是刷它稳。台北捷运不少闸机可以拍 Visa / Mastercard，有的站不行，闸机失败就买单程。到了再买悠游卡，荷兰不用提前。多次证出岛可以不退。",
  },
  {
    title: "钱",
    detail:
  ...
  },
  {
    title: "机场捷运",
    detail:
      "CI74 清晨到桃园，坐机场捷运进台北车站 A1。直达车比较快，普通车也到。大约 35–50 分钟。不要学朋友那样小巨蛋打车去桃园。12/24 赶 CZ3088：南航常停第一航厦（A12），华航常停第二航厦（A13），以登机牌为准。9:30 前离开市区。",
  },
  {
    title: "高铁",
    detail:
      "只订两张对号座：12/20 台北→台南，12/23 早班台南→台北。官网或 T Express，用护照号。大约出发前 28 天、台湾时间 0 点放票（荷兰大约前一天下午）。早鸟会便宜一点，能抢就抢。车站售票机、窗口或 7-11 ibon 用护照/订票代号取。台北车站高铁和机场捷运不在同一大厅。开车前预留 40 分钟。周日早班人多，不要赌自由座。台南高铁站到国华街坐计程车。",
  },
  {
    title: "九份",
    detail:
      "12/18 晴天：尽量上午从忠孝复兴坐 1062，大约 1 小时，悠游卡能刷。16:00 前坐回程。不要加金瓜石、十分。雨改北投或淡水老街。公共浴是裸汤，有纹身先问；要泳衣选汤屋。",
  },
  {
    title: "市内",
    detail:
...
export const checklist: ChecklistGroup[] = [
  {
    ...
    items: [
      ...
      { id: "job-letter", label: "在职证明先写模板；日期靠近面談再盖章，不要 8 月开完" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ns", label: "约上后订 NS 到 Den Haag Centraal。按你住的城市估车次，不要默认阿姆斯特丹 8 点出门" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "tpe-hotel-1", label: "订台北 12/16–19 连续 4 晚，24 小时柜台，跟酒店说 17 日清晨到" },
      { id: "nye-hotel", label: "订台北 12/23 一晚，尽量同一家" },
    ],
  },
  {
    id: "nov",
    ...
    items: [
      ...
      { id: "other-hotels", label: "订台南 3 晚（12/20–22），国华街步行圈" },
      { id: "thsr", label: "高铁对号座：护照号订 12/20、12/23 早班" },
    ],
  },
  {
    id: "week",
  ...
  },
  {
    ...
    title: "在路上",
    items: [
      { id: "souvenir", label: "12/23 买伴手礼；有脚去 101 外立面或饶河" },
...
export const permitHague = [
  {
    title: "怎么去",
    detail:
      "先用 NS 从你住的车站查到 Den Haag Centraal，再坐电车到 World Forum 或 Madurodam，步行到 Van Stolkweg 23。电车可刷银行卡，车次用 9292。别开车、别踩点。09:30 开门。住阿姆斯特丹大约 8 点前出家门；住别处按查询提早。荷兰公假馆不开。约上立刻订来回。",
  },
  {
    title: "带什么",
    detail:
