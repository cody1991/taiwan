...
export const taiwanDays: TaiwanDay[] = [
  ...
  },
  {
    ...
    title: "故宫 + 大稻埕",
    stay: "台北",
    body: "故宫周六开馆。下午回城走大稻埕。士林夜市不是必须。明天早班去台南。",
    beats: [
      "故宫散客现场买外籍票，约 NT$350。09:00–17:00，16:30 停售。不要在淘宝买团票，对不上护照。",
      "捷运淡水线到士林，出站转红 30 或计程车到故宫正馆。别走去剑潭爬山。",
      "正馆看半天就够。中午馆内或士林吃卤肉饭。",
      "下午回城：迪化街、大稻埕、霞海城隍庙。这才是这天的点。晚上近住处吃，或顺路龙山寺、华西。不要折回士林夜市。",
    ],
    tips: ["故宫后走大稻埕", "士林夜市可不去"],
    mapsQuery: "国立故宫博物院",
  },
  {
    date: "2026-12-20",
...
export const foodGroups: FoodGroup[] = [
  {
    id: "taipei-night",
    title: "台北夜市",
    when: "12/17 宁夏 · 12/19 大稻埕晚饭 · 饶河可去可不去",
    items: [
      {
        name: "蚵仔煎",
        where: "饶河或宁夏",
        note: "冬天也有。第一晚宁夏就够。选轮转快的摊。",
        mapsQuery: "饶河夜市 蚵仔煎",
...
export const foodSkip = [
  ...
  "太阳饼：别为了它去台中",
  "士林夜市：故宫那天优先大稻埕，不必折回去",
];

export const visitReserve = [
  { name: "故宫北院", need: "不用约", note: "散客现场买外籍票约 NT$350。12/19 周六开，周一休。不要淘宝团票。" },
  { name: "龙山寺、大稻埕、九份老街", need: "不用约", note: "走路进去。九份 12/18。故宫后优先大稻埕。" },
  { name: "台北 101", need: "不用约", note: "12/23 外立面免费。登顶队长就别排。" },
...
export const checklist: ChecklistGroup[] = [
  ...
  },
  {
    ...
    title: "在路上",
    items: [
      { id: "souvenir", label: "12/23 永康买伴手礼，来好队不长再买" },
