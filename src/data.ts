...
export const taiwanDays: TaiwanDay[] = [
  ...
  },
  {
    ...
    beats: [
      "散客不用预约。现场买普通参观券，外籍约 NT$350。09:00–17:00，16:30 停售。周一休馆，今天周六能进。",
...
export const visitReserve = [
  { name: "故宫北院", need: "不用约", note: "散客现场买票。外籍约 NT$350。12/19 周六开，周一休。团体导览才要预约。" },
  { name: "龙山寺、大稻埕、九份老街", need: "不用约", note: "走路进去。九份 12/18，只要赶上 1062 回程。" },
  { name: "台北 101", need: "不用约", note: "外立面免费。观景台现场买，人多就看外面。12/23 顺路。" },
...
export const lifeStay = [
  ...
  },
  {
    title: "台北住哪",
    detail:
      "12/16–19 和 12/23 尽量同一家。优先中山或台北车站。西门吵，不适合清晨补觉。去台南 3 晚把大箱子带上，或北车寄物柜。12/24 赶中午飞机，最后一晚别订士林、北投。",
  },
  {
    title: "台南住哪",
    detail:
