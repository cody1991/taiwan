...
export const taiwanDays: TaiwanDay[] = [
  ...
  },
  {
    ...
    beats: [
      ...
      "雨：淡水信义线到北投，换新北投。公共浴是裸汤，有纹身先问；要泳衣选汤屋。不要排阳明山。",
  ...
  },
  {
    ...
    beats: [
      "晚起。没去成的龙山寺、西门、或只在中山晃。YouBike 沿河骑一段也行，别骑去九份。",
...
export const lifeClothes = [
  ...
  },
  {
    title: "少带",
    detail:
      "正装、厚羽绒服、不能干的帆布鞋都不必。雨伞便利店买。常用药原包装随身。移动电源不托运。",
  },
];
...
export const lifeTransit = [
  ...
  },
  {
    title: "钱",
    detail:
      "落地换或从荷兰带 2000–4000 新台币，够第一天。荷兰换台币汇率差，其余落地取。优先 7-11 ATM。Visa / Mastercard 比 Maestro 稳。取款选台币，拒绝动态货币转换。出发前跟银行报台湾和大陆。店里刷卡。微信、支付宝不要当主力，夜市现金。不用给小费。",
  },
  {
    title: "电话",
    detail:
      "荷兰漫游很贵。手机解锁后出发前办台湾 eSIM。双卡就留国内号，到深圳再开。台湾用 Google 地图。到深圳 Google 不好用，改高德，开微信乘车码。",
  },
  {
    title: "机场捷运",
    detail:
      "CI74 清晨到桃园，坐机场捷运进台北车站 A1，大约 40 分钟。12/24 赶 CZ3088：南航常停第一航厦（A12），华航常停第二航厦（A13），以登机牌为准。9:30 前离开市区。",
  },
  {
    title: "高铁",
    detail:
      "只订两张对号座：12/20 台北→台南，12/22 早班台南→台北。官网或 T Express，用护照号。大约出发前 28 天、台湾时间 0 点放票（荷兰大约前一天下午）。车站售票机或窗口用护照取。台北车站高铁和机场捷运不在同一大厅。开车前预留 40 分钟。周日早班人多，不要赌自由座。台南高铁站到国华街坐计程车。",
  },
  {
    title: "九份",
    detail:
      "12/19 晴天：尽量上午从忠孝复兴坐 1062，大约 1 小时，悠游卡能刷。16:00 前坐回程。不要加金瓜石、十分。雨改北投：淡水信义线到北投，再换新北投。公共浴是裸汤，有纹身先问；要泳衣选汤屋。",
  },
  {
    title: "市内",
    detail:
      "不租车。台北靠捷运。台南靠走和计程车（Uber / Line Taxi）。街上几乎没垃圾桶，包装捏在包里，便利店再丢。报警 110，救护 119。",
  },
  {
    title: "LINE",
    detail:
...
export const flightNotes = [
  {
    title: "史基浦",
    detail:
      "CI74 大约 11:00 飞，国际航班提前 3 小时到，8 点前出现在航站。柜台看当天屏幕，不要凭记忆跑错楼。过夜航班：登机吃饭，然后睡。第一天台北只补觉。出发前一天华航 App 值机。",
  },
  {
    title: "行李",
    detail:
